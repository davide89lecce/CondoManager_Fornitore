...
public class AdapterRapportiInterventoInCorso extends RecyclerView.Adapter<AdapterRapportiInterventoInCorso.MyViewHolder> {
    ...
    public AdapterRapportiInterventoInCorso(ArrayList<CardRapportoIntervento> dataset, Activity activity) {
