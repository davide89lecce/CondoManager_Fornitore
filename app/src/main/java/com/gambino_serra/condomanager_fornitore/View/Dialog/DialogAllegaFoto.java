...
public class DialogAllegaFoto extends DialogFragment{
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        builder.setView(inflater.inflate(R.layout.dialog_allega_foto, null))
                        ...
                        if ( UriImmagine != null) {
                            ...
                            filepath.putFile(UriImmagine).addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                                ...
                                public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                                    ...
                                    try
                                        ...
                                        if (filepath != null)
                                            {
                                            // Salva la foto su firebase e recupera i dati necessari per tornare
                                            // all'activity precedente e salvare tutti i dati del rapporto di intervento

                                            aggiungiFoto(databaseReference, UriImmagine.getLastPathSegment().toString()    );

                                            urlDownload = urlpath.toString();
                                            SharedPreferences.Editor editor = sharedPrefs.edit();
                                            editor.putString("foto", urlDownload);
                                            editor.apply();
                                            }
                                        else
                                            {
                            ...
                            .addOnFailureListener(new OnFailureListener() {
                                ...
                                public void onFailure(@NonNull Exception e) {
                                    Toast.makeText( getActivity().getApplicationContext() , "Non è stato possibile allegare la foto", Toast.LENGTH_LONG).show();
                                    }
                            });

                            Toast.makeText(getActivity().getApplicationContext(), "immagine allegata", Toast.LENGTH_LONG).show();
    ...
    private void aggiungiFoto(DatabaseReference postRef, final String percorsoFoto) {
        postRef.runTransaction(new Transaction.Handler() {
            ...
            public Transaction.Result doTransaction(MutableData mutableData) {
                ...
                //MessaggioCondomino m = new MessaggioCondomino(counter.toString(),stringdate,"Segnalazione",uidCondomino,uidAmministratore, stabile, percorsoFoto, urlFoto);
        ...
        if (resultCode == RESULT_OK) {
            ...
            if ( requestCode == TAKE_PICTURE || requestCode == GALLERY_INTENT) {
                ...
                try {
                    ...
                    mImmagine.getLayoutParams().width = 1080;
                    mImmagine.getLayoutParams().height = 920;
